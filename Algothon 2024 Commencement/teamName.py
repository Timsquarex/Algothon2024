...
def getMyPosition(prcSoFar):
    ...
    smoothed_RSI2 = RSI.copy().shift(periods=-1)
    smoothed_RSI2.iloc[days:] = RSI.iloc[days:].ewm(alpha=alpha, adjust=False).mean()
